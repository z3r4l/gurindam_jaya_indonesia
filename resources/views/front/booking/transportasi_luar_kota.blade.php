<div class="row g-3">
    {{-- <div class="col-md-3 col-6">
        <div class="card" style="width: 11rem; cursor: pointer;"
            onclick="toggleCardSelection('Pesawat', '{{ asset('front/img/pesawat.png') }}', 'pesawat')">
            <div class="position-absolute d-flex justify-content-start m-3">
                <input type="checkbox" name="pesawat" id="pesawat"
                    onchange="toggleSelection('Pesawat', '{{ asset('front/img/pesawat.png') }}', 'pesawat'))"
                    style="pointer-events: none;">
            </div>
            <img src="{{ asset('front/img/pesawat.png') }}" class="card-img-top"
                alt="{{ asset('front/img/pesawat.png') }}">
            <div class="card-body">
                <h5 class="card-title">Pesawat</h5>
            </div>
        </div>
    </div> --}}
    @foreach ($outer_city as $item)
    <div class="col-md-3 col-6">
        <div class="card" style="width: 11rem; cursor: pointer;"
    ...
    <!-- Modal -->
    <div class="modal fade" id="{{ $item->id }}_{{ str_replace(' ', '', $item->name) }}_{{ str_replace(' ', '', $item->created_at) }}" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-labelledby="paket_aLabel" aria-hidden="true">
