<div class="row g-3">
    {{-- <div class="col-md-3 col-6">
        <div class="card" style="width: 11rem; cursor: pointer;"
            onclick="toggleCardSelection('Aston', '{{ asset('front/img/aston.png') }}', 'aston')">
            <div class="position-absolute d-flex justify-content-start m-3">
                <input type="checkbox" name="aston" id="aston"
                    onchange="toggleSelection('aston', '{{ asset('front/img/aston.png') }}', 'aston'))"
                    style="pointer-events: none;">
            </div>
            <img src="{{ asset('front/img/aston.png') }}" class="card-img-top" alt="{{ asset('front/img/aston.png') }}">
            <div class="card-body">
    ...
    <div class="col-md-3 col-6">
        <div class="card" style="width: 11rem; cursor: pointer;"
            ...
            <div class="card-body">
                <h5 class="card-title">Hotel {{ $item->name }}</h5>
            </div>
        </div>
